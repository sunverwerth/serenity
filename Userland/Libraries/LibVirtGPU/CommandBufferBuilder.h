...
public:
    ...
    void append_draw_vbo(u32 count, Protocol::PipePrimitiveTypes);
    void append_gl_clear(float r, float g, float b, float a);
    void append_gl_clear(float d);
    ...
    void append_gl_viewport(int width, int height);
    void append_set_framebuffer_state_no_attach(int width, int height);
