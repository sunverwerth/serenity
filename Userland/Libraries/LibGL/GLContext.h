...
public:
    ...
    virtual void gl_tex_sub_image_2d(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLenum type, const void* pixels) = 0;
    ...
    virtual void gl_pixel_store(GLenum pname, GLdouble param) = 0;
